...
import com.spring.jdbc.annotation.config.JavaConfig;
import com.spring.jdbc.annotation.dao.StudentDaoImplement;
...
public class App {
    public static void main(String[] args) {
        ...
        StudentDaoImplement dao = context.getBean(StudentDaoImplement.class);
